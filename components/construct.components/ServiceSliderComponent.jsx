...
const ServiceSliderComponent = () => {
  ...
  const [styleSelected, setStyleSelected] = useState('modern');
  ...
  return (
    <>
        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex -mx-4">
            {services.map((service, index) => (
              ...
              >
                <div className="bg-white rounded-lg shadow p-6 text-center h-80 cursor-pointer hover:scale-95 relative">
                  <Image
                    src={service.icon}
                    alt={service.name}
                    fill
                  ...
                  <h3
                    ...
                    className="p-4 rounded-lg text-xl font-semibold mb-2 relative z-10"
                  >
                    {service.name}
                  </h3>
                  <p className="text-gray-600 max relative z-10">{}</p>
      ...
      >
        <div className="p-10">
          <ServiceGallery
            section={`${modalDetail}.${styleSelected || 'modern'}`}
          />
        </div>
